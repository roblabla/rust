...
mod platform {
    ...
    #[cfg(any(target_os = "android", target_os = "redox", target_os = "solaris", target_os = "horizon"))]
    #[inline]
    ...
    #[cfg(not(any(target_os = "android", target_os = "redox", target_os = "solaris", target_os = "horizon")))]
    #[inline]
    unsafe fn aligned_malloc(layout: &Layout) -> *mut u8 {
